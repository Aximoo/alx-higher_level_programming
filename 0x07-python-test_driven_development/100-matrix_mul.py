#!/usr/bin/python3
"""This module containn a function that multiplies two matrix"""


def matrix_mul(m_a, m_b):
    """matrix_mul functtion that multiplies two matrix
    Args:
    ...
    # variables to veriffy if both m_a and m_b can be multiplied
    num_colum1 = 0
    num_row2 = 0
    ...
    # Check requirementss for matrix m_b
    if m_b == []:
